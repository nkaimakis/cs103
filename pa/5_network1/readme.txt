...
:
discussion with peers, online resources, provided 
guiding document especially
...
:Deciding how best to structure the code, io streams using both cin and getline
